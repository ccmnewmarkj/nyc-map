<script>
	...
	let languageHeader;
	const languageIcon = `<svg xmlns="http://www.w3.org/2000/svg" height="15px" viewBox="0 -960 960 960" width="15px" fill="var(--language-color)"><path
...
`;
	...
	$: languageHeader =
		...
		// 					${languageIcon} Search by primary languages <span style="font-weight: 400;">(${languageList.length - value.length} more)</span></span>
